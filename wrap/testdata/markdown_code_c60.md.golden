Here is a paragraph before a code block that should be
rewrapped because it is too long for sixty columns.
...
Paragraph between code blocks that is also quite long and
needs to be rewrapped to fit the column.
...
Final paragraph after all the code blocks that should be
rewrapped properly.
